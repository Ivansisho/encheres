...
var VaadinDevTools = class extends lit_exports.LitElement {
  constructor() {
    super(...arguments);
    this.expanded = false;
    this.messages = [];
  ...
  getStatusColor(status) {
    if (status === ConnectionStatus.ACTIVE) {
      return lit_exports.css`hsl(${VaadinDevTools.GREEN_HSL})`;
    } else if (status === ConnectionStatus.INACTIVE) {
      return lit_exports.css`hsl(${VaadinDevTools.GREY_HSL})`;
    } else if (status === ConnectionStatus.UNAVAILABLE) {
      return lit_exports.css`hsl(${VaadinDevTools.YELLOW_HSL})`;
    } else if (status === ConnectionStatus.ERROR) {
      return lit_exports.css`hsl(${VaadinDevTools.RED_HSL})`;
    } else {
      return lit_exports.css`none`;
    }
  }
      ...
      >
        <div class="message-content">
          ...
          <div class="message-details" ?hidden="${!messageObject.details && !messageObject.link}">
            ${messageObject.details ? lit_exports.html`<p>${messageObject.details}</p>` : ""}
            ${messageObject.link ? lit_exports.html`<a class="ahreflike" href="${messageObject.link}" target="_blank">Learn more</a>` : ""}
          </div>
          ${messageObject.persistentId ? lit_exports.html`<div
  ...
  render() {
    return lit_exports.html` <div
      ...
      if (tab.activate)
        ...
        ${this.tabs.map((tab) => this.activeTab === tab.id ? tab.render.call(this) : lit_exports.nothing)}
      </div>
      ...
      >
        ${this.unreadErrors ? lit_exports.html`<svg
              fill="none"
              height="16"
              viewBox="0 0 16 16"
              width="16"
        ...
        ></span>
        ${this.splashMessage ? lit_exports.html`<span class="status-description">${this.splashMessage}</span></div>` : lit_exports.nothing}
      </div>`;
  }
  renderLog() {
    return lit_exports.html`<div class="message-tray">${this.messages.map((msg) => this.renderMessage(msg))}</div>`;
  }
  activateLog() {
    this.unreadErrors = false;
    this.updateComplete.then(() => {
  ...
  renderInfo() {
    return lit_exports.html`<div class="info-tray">
  ...
  renderFeatures() {
    return lit_exports.html`<div class="features-tray">
      <p>
      ...
      ${this.features.map((feature) => lit_exports.html`<div class="feature">
          <label class="switch">
            <input
...
VaadinDevTools.BLUE_HSL = lit_exports.css`206, 100%, 70%`;
VaadinDevTools.GREEN_HSL = lit_exports.css`145, 80%, 42%`;
VaadinDevTools.GREY_HSL = lit_exports.css`0, 0%, 50%`;
VaadinDevTools.YELLOW_HSL = lit_exports.css`38, 98%, 64%`;
VaadinDevTools.RED_HSL = lit_exports.css`355, 100%, 68%`;
